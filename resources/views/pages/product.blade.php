                                    ...
                                    <div class="product-details-thumbnail">
                                        <div class="product-thumbnail-slider" id="thumb-gallery">
                                            @foreach($product->images as $image)
                                                <figure class="pro-thumb-item" data-mfp-src="{{ $image->path }}">
                                        ...
                                        <div class="product-meta">
                                            ...
                                            <span class="posted_in">Categories:
                                                @foreach($product->categories as $category)
                                                    <a href="#">{{ ucfirst($category->name) }}@if($category != $product->categories->last()) , @endif</a>
                                                @endforeach
...
{{--                                            <a href="#">Shop</a>--}}
                                            ...
                                            <span class="tagged_as">Tags:
                                                @foreach($product->tags as $tag)
                                                    <a href="#">{{ ucfirst($tag->name) }}@if($tag != $product->tags->last()) , @endif</a>
                                                @endforeach
{{--                                            <a href="#">Seller,</a>--}}
{{--                                            <a href="#">Modern,</a>--}}
{{--                                            <a href="#">Parts</a>--}}
                                                        ...
                                                        <div class="rating-item">
                                                            ...
                                                            <div class="rating-author-txt">
                                                                ...
                                                                <div class="rating-meta">
                                                                    <h3>{{ $review->author }}</h3>
                                                                    <span class="time">- {{ $review->created_at->toFormattedDateString() }}</span>
                                                                </div>
